...
//        rotationAngle = -M_PI_2;
    ...
    sidebarRect = CGRectMake(0, 0, viewSize.width, 22 + 65);
                flipButtonRect = CGRectMake(viewSize.width - 50, 35, 30, 20);
                torchButtonRect = CGRectMake(viewSize.width / 2 - 24, 35, 30, 20);
                cancelButtonRect = CGRectMake(5, 35, 50, 30);
