...
- (void) setupBadgeViewWithString:(NSString *)string
{
    ...
    badgeSize.width = badgeSize.width < 20 ? 20 : badgeSize.width;
    ...
    [badgeLabel setFrame:CGRectMake(self.bounds.size.width - 30 + horizontal, -(badgeSize.height / 2) - 0 + vertical, badgeSize.width,  badgeSize.width > 20 ? badgeSize.height : badgeSize.width)];
    [self setupBadgeStyle];
