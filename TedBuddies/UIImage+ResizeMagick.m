...
- (UIImage *) resizedImageByMagick: (NSString *) spec
{
    ...
    if([spec hasSuffix:@"!"]) {
        ...
        NSUInteger width = [[widthAndHeight objectAtIndex: 0] doubleValue];
        NSUInteger height = [[widthAndHeight objectAtIndex: 1] doubleValue];
    ...
    if ([widthAndHeight count] == 1) {
        return [self resizedImageByWidth: [spec doubleValue]];
    }
    if ([[widthAndHeight objectAtIndex: 0] isEqualToString: @""]) {
        return [self resizedImageByHeight: [[widthAndHeight objectAtIndex: 1] doubleValue]];
    }
